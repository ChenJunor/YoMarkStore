            ...
            <div class="well">  
                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active in" id="home">
                        <form id="tab" action="/B2cShop/servlet/UserServlet?action=insertuser" method="post">
                            <label>用户名</label>
                            ...
                            <label>类型</label>
                            <select name="type" id="user_type" class="input-xlarge">
                                <option value=1>卖家</option>
                                <option value=0>买家</option>
                            </select>
                            
                            <label>等级</label>
                            <select name="level" id="user_level" class="input-xlarge">
                            ...
                            <label>性别</label>
                            <select name="sex" id="user_sex" class="input-xlarge">
                                <option value="man">男</option>
                                <option value="woman">女</option>
                            </select>
                    
                            <label>生日</label>
                            <input type="text" class="input-xlarge" name="birth">

                            <label>联系方式</label>
                            <input type="text" class="input-xlarge" name="phone">

                            <label>地址</label>
                            <textarea value="phone" rows="3" class="input-xlarge" name="address">
                            </textarea>
                            <div>
